...
<div class="row">
    ...
    <div class="col-md-9">
		...
		<?= $form->field($model, 'status',  [ 'addon' => ['prepend' => ['content' => '<i class="glyphicon glyphicon-heart"></i>']]])->dropDownList(Ticket::statusOptions())?>
    ...
    <?= $form->field($model, 'cause')->widget(kartik\markdown\MarkdownEditor::classname(),
    	['height' => 300]
    ); ?>

	<?= $form->field($model, 'solution')->widget(kartik\markdown\MarkdownEditor::classname(),
		['height' => 300]
	);  ?>
